CREATE TABLE `resource` (
	...
	`created_at` integer DEFAULT 1729826524765 NOT NULL,
	`updated_at` integer DEFAULT 1729826524765 NOT NULL,
	`created_by` text NOT NULL,
	`updated_by` text NOT NULL,
	`status` text DEFAULT 'N' NOT NULL,
	`parent_id` integer NOT NULL,
	`resource_code` text NOT NULL,
	`resource_name_en` text NOT NULL,
	`resource_name_zh_cn` text NOT NULL,
